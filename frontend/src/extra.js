                                                      ...
                                                      <table class="table">
                                                            ...
                                                            <tbody>
                                                                  ...
                                                                  <th scope="row" class="border-0">
                                                                        <div class="p-2">
                                                                              <img src="https://m.media-amazon.com/images/I/61eMJalktNL._AC_UL320_.jpg" alt="photo" width={50} height={50} class="img-fluid rounded shadow-sm" />
                                                                              <div class="ml-3 d-inline-block align-middle mx-2">
                                                                                    <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block align-middle">Title</a></h5><span class="text-muted font-weight-normal font-italic d-block">
                                                                                          {/* {
                                                                                                data.quantity > 10 ? (
                                                                  ...
                                                                  <td class="border-0 align-middle"><strong>200 %</strong></td>
                                                                  <td class="border-0 align-middle"><strong>&#8377; 1266</strong></td>
                                                                  <td class="border-0 align-middle">
                                                                        <div class="d-grid gap-2 d-md-block">
                                                                              <button class="btn btn-sm mx-auto" type="button" style={{ height: "3rem", width: "3rem" }}>-</button>
                                                                              <strong className='btn' style={{ height: "3rem", width: "5rem" }}>3</strong>
                                                                              <button class="btn btn-sm mx-auto" type="button" style={{ height: "3rem", width: "3rem" }}>+</button>
                                                                        </div>
                                                                  </td>
                                                                  ...
                                                                  <td class="border-0 align-middle" ><FontAwesomeIcon icon="trash" className='text-danger mx-3' style={{ height: "20px", width: "20px" }} /></td>
                                          ...
                                          <div class="col-lg-6">
                                                ...
                                                <div class="p-4">
                                                      ...
                                                      <ul class="list-unstyled mb-4">
                                                            <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Order Subtotal </strong><strong>&#8377;</strong></li>
                                                      ...
                                                      </ul><button class="btn btn-dark rounded-pill py-2 btn-block" >Procceed to checkout</button>
                                                </div>
                                          </div>
                                    </div>
